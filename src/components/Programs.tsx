          ...
          <div className="w-full h-full grid items-center overflow-y-auto p-5">
            <div className="bg-white p-6 rounded-lg shadow-2xl max-w-3xl mx-auto relative">
              ...
              <div className="mt-4 flex justify-center items-center relative">
                ...
                {/* Navigation Buttons */}
                <div
                  className="absolute top-1/2 left-4 transform -translate-y-1/2 text-red-700 font-bold cursor-pointer text-3xl"
                  onClick={prevImage}
                >
                  &#10094; {/* Left Arrow */}
                </div>
                <div
                  className="absolute top-1/2 right-4 transform -translate-y-1/2 text-red-700 font-bold cursor-pointer text-3xl"
                  onClick={nextImage}
                >
                  &#10095; {/* Right Arrow */}
                </div>
