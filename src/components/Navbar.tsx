   ...
   return (
     <nav className="bg-maroon-700 p-4 shadow-md">
       <div className="container mx-auto flex items-center justify-between">
         ...
         {/* Desktop Menu */}
         <ul className="hidden lg:flex justify-center space-x-10 text-white font-medium text-lg w-full">
           ...
           <li>
                <button
                  onClick={() => window.open("https://forms.gle/2ugQ3cy8NG3M9rUg8", "_blank", "noopener,noreferrer")}
       ...
       {isOpen && (
         <div className="lg:hidden bg-maroon-800 p-4">
           ...
           <li><Link href="#home" className="nav-link" onClick={() => setIsOpen(false)}>Home</Link></li>
             ...
             <li><Link href="#events" className="nav-link" onClick={() => setIsOpen(false)}>Events</Link></li>
             <li><Link href="#team" className="nav-link" onClick={() => setIsOpen(false)}>Our Team</Link></li>
             <li><Link href="#contact" className="nav-link" onClick={() => setIsOpen(false)}>Contact Us</Link></li>
             <li><button className="border border-white text-white px-4 py-2 rounded-lg transition duration-300 hover:bg-white hover:text-maroon-700">
   Join IEEE
 </button></li>
           </ul>
         </div>
